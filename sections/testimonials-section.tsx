...
export function TestimonialsSection({ lang, dictionary }: TestimonialsSectionProps) {
  ...
  const testimonials = [
    {
      ...
      position: lang === "en" ? "CEO, Tech Innovations" : "الرئيس التنفيذي، تك إنوفيشنز",
    },
    {
      quote:
        lang === "en"
      ...
      position: lang === "en" ? "Director, Gulf Development" : "مدير، الخليج للتطوير",
    },
    {
      quote:
        lang === "en"
  ...
  return (
    <section ref={ref} className="container py-16 bg-muted/30 rounded-xl">
      <motion.div
              ...
              <CardContent className={`pt-6 ${isRtl ? "text-right" : "text-left"}`}>
                ...
                <div className="mt-6 flex items-center">
                  <div className="h-10 w-10 rounded-full bg-muted overflow-hidden">
                    <Image src="/placeholder.svg?height=40&width=40" alt={testimonial.author} width={40} height={40} />
                  </div>
