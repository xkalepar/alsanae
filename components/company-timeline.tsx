      ...
      <div className="space-y-12">
        {sortedProjects.map((project, index) => (
          ...
          >
            ...
            {/* Content card */}
            <div className={`w-full md:w-5/12 ${isRtl ? (index % 2 === 0 ? "text-right" : "text-left") : ""}`}>
              <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge variant={isOngoing(project.endDate) ? "default" : "secondary"}>
                  ...
                  <div className="mt-4 pt-4 border-t">
                    <div className="flex items-center justify-between text-xs text-muted-foreground">
                      <span>
                        {lang === "en" ? "Started:" : "بدأ:"} {new Date(project.startDate).toLocaleDateString()}
                      </span>
                      <span>
                        {isOngoing(project.endDate)
                          ? lang === "en"
